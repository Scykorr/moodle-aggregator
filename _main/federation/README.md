...
- `start-gui.pyw` / `server_manager.py`: окно со списком HTTP(S)-серверов,
  добавлением и удалением строк, проверкой одного/всех адресов и сохранением.
